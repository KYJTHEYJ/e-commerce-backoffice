...
public enum ErrorEnum {
    ...
    , ERR_ORDER_CHANGE_FORBIDDEN(HttpStatus.FORBIDDEN, MSG_ORDER_CHANGE_FORBIDDEN)
    , ERR_ORDER_STATUS_INVALID_TRANSITION(HttpStatus.BAD_REQUEST, MSG_ORDER_STATUS_INVALID_TRANSITION)
    , ERR_ORDER_ALREADY_CANCELLED(HttpStatus.NOT_FOUND, MSG_ORDER_ALREADY_CANCELLED);
